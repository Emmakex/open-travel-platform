...
export const dictionaries = {
  en: {
    ...
    booking: {
      ...
      intro: "Choose a departure and add the travellers. The final availability and price are checked before your reservation is created.",
      customerRequired: "Sign in to continue.",
      customerRequiredCopy: "Sign in or create a customer account to complete this reservation.",
      signIn: "Sign in →",
      staffActive: "A staff account is currently signed in. Switch to a customer account to make a personal reservation.",
      openOperator: "Open operator area →",
      departure: "Departure",
      ...
      departuresCopy: "Choose a departure below. Availability and prices are checked again when you reserve.",
      left: "left",
      back: "← Back to trip",
      noDepartures: "No departures are currently available.",
      writesDisabled: "Online reservations are unavailable right now.",
      errors: {
        bookingDisabled: "Online reservations are unavailable right now.",
  ...
  es: {
    ...
    booking: {
      ...
      intro: "Elige una salida y añade los viajeros. La disponibilidad y el precio final se comprueban antes de crear la reserva.",
      customerRequired: "Inicia sesión para continuar.",
      customerRequiredCopy: "Inicia sesión o crea una cuenta de cliente para completar esta reserva.",
      signIn: "Iniciar sesión →",
      staffActive: "Hay una cuenta de personal iniciada. Cambia a una cuenta de cliente para hacer una reserva personal.",
      openOperator: "Abrir área de operador →",
      departure: "Salida",
      travellers: "Viajeros",
      spaces: "plazas",
      ...
      departuresCopy: "Elige una salida. La disponibilidad y los precios se vuelven a comprobar al reservar.",
      left: "disponibles",
      back: "← Volver al viaje",
      noDepartures: "No hay salidas disponibles actualmente.",
      writesDisabled: "Las reservas online no están disponibles ahora mismo.",
      errors: {
        bookingDisabled: "Las reservas online no están disponibles ahora mismo.",
