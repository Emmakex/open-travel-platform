...
export default async function RegisterPage({
  ...
  if (!identityConfig.customerAuthEnabled) redirect("/account/sign-in?error=registration-disabled");
      ...
      <div className={`container ${styles.shell}`}>
        <section className={styles.panel}>
          ...
          <p className={styles.lead}>
            {isEs
              ? "Crea una cuenta para guardar reservas y consultar tus viajes desde cualquier sesión."
              : "Create an account to keep reservations and access your trips across sessions."}
          </p>
